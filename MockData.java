...
public class MockData {
    ...
    public static Challenge[] getChallenges(){
        ...
        challenges[1] = new Challenge("ready","simple duell mode", currentChallenger, currentParticipant, "3-4-2-1-3");
        challenges[2] = new Challenge("on_hold","simple duell mode", currentParticipant, currentChallenger, "2-1-1-0-3");
        challenges[3] = new Challenge("waiting","simple duell mode", currentChallenger, anotherParticipant, "0-0-0-0-0");
